...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Last year Electronics and Communication student",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
...
${this.wrapWithColor(
  "   Hands-on experience in schematic making, PCB prototyping",
  "#ffffff"
)}
${this.wrapWithColor(
  "   and firmware designing in various softwares and IDEs.",
  "#ff8c00"
)}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
  "   Independently designing, developing, testing and debugging",
  "#ffffff"
)}
${this.wrapWithColor("   embedded C projects.", "#ffffff")}

${this.wrapWithColor("⚡ Strengths", "#ff8c00")}
${this.wrapWithColor(
  "   Fast learner with a strong ability to grasp in any",
  "#ffffff"
)}
${this.wrapWithColor(
  "   environment and collaborate effectively within",
  "#ffffff"
)}
${this.wrapWithColor(
  "   cross-functional teams on complex systems.",
  "#ffffff"
)}
...
<span style="color: #00ffff;">SWASEMI PVT LTD | Embedded Systems Intern</span>
${this.wrapWithColor(
  "Nov 2025 - Present | Pirana-Piplaj Road, Ahmedabad, India",
  "#ffffff"
)}
${this.wrapWithColor(
  "Hardware & Firmware intern, from product inception to completion",
  "#98fb98"
)}

• ${this.wrapWithColor("Firmware developer", "#ffa07a")} - ${this.wrapWithColor(
      "STM32, Renesas, ESP32 modules and WCH32 controllers series firmware",
      "#ffffff"
    )}
• ${this.wrapWithColor("Hardware design", "#ffa07a")} - ${this.wrapWithColor(
      "Altium, Eagle, and KiCad for hardware design and verification",
      "#ffffff"
    )}
• ${this.wrapWithColor("Industrial sensors", "#ffa07a")} - ${this.wrapWithColor(
      "Contributed to industrial sensor production",
      "#ffffff"
    )}
• ${this.wrapWithColor("Protocols", "#ffa07a")} - ${this.wrapWithColor(
      "RS485, Modbus, RS232 and more",
      "#ffffff"
    )}
• ${this.wrapWithColor("IoT technologies", "#ffa07a")} - ${this.wrapWithColor(
      "MQTT, BLE, Wi-Fi, cellular networks, TCP and UDP",
      "#ffffff"
    )}
• ${this.wrapWithColor("Modules", "#ffa07a")} - ${this.wrapWithColor(
      "SIMCOM and Quectel modules for data communication via MQTT",
      "#ffffff"
    )}
• ${this.wrapWithColor("Product lifecycle", "#ffa07a")} - ${this.wrapWithColor(
      "Learned how a product is actually made, tested, and sold to industry standards",
      "#ffffff"
    )}
• ${this.wrapWithColor(
      ...
      "Part of verification and technical purchase department for high-scale testing and procurement",
      "#ffffff"
    )}
• ${this.wrapWithColor("On-site testing", "#ffa07a")} - ${this.wrapWithColor(
      "Went on-site for testing or visiting to check various parameters",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "C, Embedded C, STM32Cube IDE, ESP-IDF, E2 Studio, Altium, KiCad, EAGLE, RS485, Modbus, RS232, MQTT, BLE, Wi-Fi, TCP/IP, UDP",
      "#87cefa"
    )}

${this.wrapWithColor("🏗️ Side projects", "#00ffff")}
• ${this.wrapWithColor("ESP32 series controllers", "#ffa07a")} - ${this.wrapWithColor(
      "Various mini and side projects",
      "#ffffff"
    )}`;
...
${this.wrapWithColor("📊 SPI (SEM-6):", "#ff8c00")}  ${this.wrapWithColor(
      "7.61 / 10.0",
      "#ffffff"
    )}
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Higher Secondary - Shree Durga Vidhyalaya ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "└──────────────────────────────────────────────────┘",
...
${this.wrapWithColor("📊 Pr:", "#ff8c00")}          ${this.wrapWithColor(
      "48%",
      "#ffffff"
    )}
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Foundation of my embedded systems journey ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "╰──────────────────────────────────────────────────╯",
  ...
  showSkills(outputElement = this.output) {
    const skills = `<span style="color: #ffff00; font-weight: bold;">🗣️ LANGUAGES</span>

• ${this.wrapWithColor("C", "#ffffff")}
• ${this.wrapWithColor("Embedded C", "#ffffff")}
• ${this.wrapWithColor("Python", "#ffffff")}
• ${this.wrapWithColor("HTML/CSS", "#ffffff")}
• ${this.wrapWithColor("JavaScript", "#ffffff")}

<span style="color: #ffff00; font-weight: bold;">🔌 HARDWARE</span>

• ${this.wrapWithColor("Arduino (UNO, Nano, Nano BLE 33 Sense)", "#ffffff")}
• ${this.wrapWithColor("ESP32 (Wroom, C3, S3)", "#ffffff")}
• ${this.wrapWithColor("NodeMCU 8266", "#ffffff")}
• ${this.wrapWithColor("STM32 (C0, H7, F7, F1, F0)", "#ffffff")}
• ${this.wrapWithColor("Renesas (RA, RX)", "#ffffff")}

<span style="color: #ffff00; font-weight: bold;">🌐 PROTOCOLS</span>

• ${this.wrapWithColor("SPI, I2C, I2S, UART, USB, CAN (Basic)", "#ffffff")}
• ${this.wrapWithColor("RS485, Modbus, RS232, Ethernet", "#ffffff")}
• ${this.wrapWithColor("TCP/IP, UDP, Wi-Fi, LoRa, BLE, MQTT", "#ffffff")}

<span style="color: #ffff00; font-weight: bold;">🛠️ DEV TOOLS</span>

• ${this.wrapWithColor("STM32Cube IDE, Arduino IDE, ESP-IDF, E2 Studio", "#ffffff")}
• ${this.wrapWithColor("AntiGravity, VS Code, Altium, KiCad, EAGLE", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:divymistry11@gmail.com" style="color: #ffffff; text-decoration: none;">divymistry11@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://divy.me" target="_blank" style="color: #ffffff; text-decoration: none;">divy.me</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/LostFrequencies11" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/LostFrequencies11</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/divy-mistry" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/divy-mistry</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      {
        title: "Trackerr",
        description: "Low power, long range tracker sending GPS, DHT11 and RSSI values via LoRa SX1278 between Arduino Nano 33 (Tx) and ESP32 (Tx & Rx), printed on OLED. Circuitry converted to PCB designed on KiCad and Altium.",
        image: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='300' height='180'><rect width='300' height='180' fill='%23f9c74f'/><text x='50%25' y='50%25' font-size='22' fill='%231d3557' text-anchor='middle' dominant-baseline='middle' font-family='monospace'>TRACKERR</text></svg>",
        technologies: ["ESP32", "Arduino Nano BLE 33", "LoRa SX1278", "Neo-6M GPS", "KiCad", "Altium"],
      },
      {
        title: "Fluid Level Detection",
        description: "CNN deep learning model trained with TensorFlow and TensorFlow Lite on a custom dataset, deployed on Raspberry Pi 3 with Python to accept or reject bottles based on fill level.",
        image: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='300' height='180'><rect width='300' height='180' fill='%23a8dadc'/><text x='50%25' y='50%25' font-size='22' fill='%231d3557' text-anchor='middle' dominant-baseline='middle' font-family='monospace'>FLUID LEVEL</text></svg>",
        technologies: ["Raspberry Pi 3", "Python", "TensorFlow Lite", "Colab"],
      },
      {
        title: "Parking Management with STM32",
        description: "STM32F030F4P6 and IR sensors detect empty and full parking slots, displayed on a 16x2 LCD. Shows 'THE PARKING IS FULL' when all slots are occupied.",
        image: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='300' height='180'><rect width='300' height='180' fill='%232a9d8f'/><text x='50%25' y='50%25' font-size='22' fill='%23f1faee' text-anchor='middle' dominant-baseline='middle' font-family='monospace'>STM32 PARKING</text></svg>",
        technologies: ["STM32F030F4P6", "IR Sensor", "LCD 16x2", "STM32Cube IDE"],
      },
      {
        title: "Smart Door Security",
        description: "ESP32-hosted webpage to enter an ID and password to open the door. Three wrong attempts trigger a buzzer and send an email to the owner via SMTP.",
        image: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='300' height='180'><rect width='300' height='180' fill='%23f3722c'/><text x='50%25' y='50%25' font-size='22' fill='%23ffffff' text-anchor='middle' dominant-baseline='middle' font-family='monospace'>DOOR SECURITY</text></svg>",
        technologies: ["ESP32", "HTML", "Arduino IDE", "Buzzer", "SMTP"],
      },
      {
        title: "Plant Care",
        description: "Automatic plant watering system monitoring moisture and humidity with NodeMCU8266, DHT11, capacitive soil moisture sensor and relay. Connected to Arduino IoT Cloud for remote access.",
        image: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='300' height='180'><rect width='300' height='180' fill='%23f1c40f'/><text x='50%25' y='50%25' font-size='22' fill='%231d3557' text-anchor='middle' dominant-baseline='middle' font-family='monospace'>PLANT CARE</text></svg>",
        technologies: ["NodeMCU 8266", "DHT11", "Soil Moisture Sensor", "Arduino IoT Cloud"],
      },
      {
        title: "Audio Amplifier",
        description: "Audio amplifier circuit taking stereo AUX input, converting it to mono and passing it through an LM386 for a louder output on a speaker.",
        image: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='300' height='180'><rect width='300' height='180' fill='%23457b9d'/><text x='50%25' y='50%25' font-size='22' fill='%23ffffff' text-anchor='middle' dominant-baseline='middle' font-family='monospace'>AUDIO AMP</text></svg>",
        technologies: ["LM386", "Capacitors", "Resistors", "Speaker"],
      },
    ];
  }
      ...
      resume: {
        ...
        contents: {
          "about.txt": {
            type: "file",
            content:
              "Last year Electronics and Communication student specializing in embedded systems, proficient in C & Python, controller based Firmware and Hardware design.",
          },
          "skills.md": {
            type: "file",
            content:
              "# Skills: C, Embedded C, Python, STM32, ESP32, Arduino, Renesas, Altium, KiCad, EAGLE, RS485, Modbus, MQTT",
          },
          projects: {
            type: "directory",
            contents: {
              "trackerr.md": {
                type: "file",
                content: "LoRa GPS tracker built with ESP32, Arduino Nano 33 and LoRa SX1278.",
              },
              "plant-care.md": {
                type: "file",
                content: "Automatic plant watering with NodeMCU8266 and Arduino IoT Cloud.",
              },
              "stm32-parking.md": {
                type: "file",
                content: "Parking management system with STM32F030F4P6 and IR sensors.",
              },
            },
          },
        },
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "divy@mistry: ~/interactive-resume";
...
╚█████╔╝   ╚═╝      ╚██████╔╝      ╚═╝`;
    ...
    role.textContent = "Embedded Systems • Firmware • PCB Design";
    ...
    url.textContent = "divymistry • embedded systems";
